...
void wcvesc_encode_conf_current_limits_in(wccan_frame_t* frame, uint8_t unit_id, float min_curr, float max_curr){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_CONF_CURRENT_LIMITS_IN, unit_id));
...
void wcvesc_encode_conf_current_limits(wccan_frame_t* frame, uint8_t unit_id, float min_curr, float max_curr){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_CONF_CURRENT_LIMITS, unit_id));
    wcvesc_push_f32(wccan_frame_get_data(frame), min_curr, 1000.0f);
