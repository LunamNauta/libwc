...
void wcvesc_decode_id(canid_t id, wcvesc_packet_id_t* out_packet_id, uint8_t* out_unit_id){
    *out_unit_id = id & 255;
    *out_packet_id = (wcvesc_packet_id_t)((id >> 0x8) & 0xff);
}
...
void wcvesc_encode_conf_store_current_limits_in(wccan_frame_t* frame, uint8_t unit_id, float min_curr, float max_curr){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_CONF_STORE_CURRENT_LIMITS_IN, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), min_curr, 1000.0f);
    wcvesc_push_f32(wccan_frame_get_data(frame)+4, max_curr, 1000.0f);
...
void wcvesc_encode_conf_store_current_limits(wccan_frame_t* frame, uint8_t unit_id, float min_curr, float max_curr){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_CONF_STORE_CURRENT_LIMITS, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), min_curr, 1000.0f);
    wcvesc_push_f32(wccan_frame_get_data(frame)+4, max_curr, 1000.0f);
    wccan_frame_set_len(frame, 8);
}
void wcvesc_encode_conf_current_limits_in(wccan_frame_t* frame, uint8_t unit_id, float min_curr, float max_curr){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_CONF_CURRENT_LIMITS_IN, unit_id), true);
    wcvesc_push_i32(wccan_frame_get_data(frame), min_curr*1000);
    wcvesc_push_i32(wccan_frame_get_data(frame)+4, max_curr*1000);
    wccan_frame_set_len(frame, 8);
}
void wcvesc_encode_conf_current_limits(wccan_frame_t* frame, uint8_t unit_id, float min_curr, float max_curr){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_CONF_CURRENT_LIMITS, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), min_curr, 1000.0f);
    wcvesc_push_f32(wccan_frame_get_data(frame), max_curr, 1000.0f);
    wccan_frame_set_len(frame, 8);
}
void wcvesc_encode_current_brake_rel(wccan_frame_t* frame, uint8_t unit_id, float current){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_SET_CURRENT_BRAKE_REL, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), current, 100000.0f);
    wccan_frame_set_len(frame, 4);
}
void wcvesc_encode_current_brake(wccan_frame_t* frame, uint8_t unit_id, float current){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_SET_CURRENT_BRAKE, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), current, 1000.0f);
    wccan_frame_set_len(frame, 4);
}
void wcvesc_encode_current_rel(wccan_frame_t* frame, uint8_t unit_id, float current){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_SET_CURRENT_REL, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), current, 100000.0f);
    wccan_frame_set_len(frame, 4);
}
void wcvesc_encode_current(wccan_frame_t* frame, uint8_t unit_id, float current){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_SET_CURRENT, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), current, 1000.0f);
    wccan_frame_set_len(frame, 4);
}
void wcvesc_encode_erpm(wccan_frame_t* frame, uint8_t unit_id, float erpm){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_SET_RPM, unit_id), true);
    wcvesc_push_i32(wccan_frame_get_data(frame), erpm);
    wccan_frame_set_len(frame, 4);
}
void wcvesc_encode_duty(wccan_frame_t* frame, uint8_t unit_id, float duty){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_SET_DUTY, unit_id), true);
    wcvesc_push_f32(wccan_frame_get_data(frame), duty, 100000.0f);
    wccan_frame_set_len(frame, 4);
}
void wcvesc_encode_pos(wccan_frame_t* frame, uint8_t unit_id, float pos){
    wccan_frame_zero(frame);
    wccan_frame_set_id(frame, wcvesc_encode_id(WCVESC_SET_POS, unit_id), true);
    wcvesc_push_i32(wccan_frame_get_data(frame), pos);
    wccan_frame_set_len(frame, 4);
}

wcvesc_status1_t wcvesc_decode_status1(const wccan_frame_t* frame){
    wcvesc_status1_t out;
    out.erpm = wcvesc_pop_f32(wccan_frame_get_data(frame), 1.0f);
    out.current = wcvesc_pop_f16(wccan_frame_get_data(frame)+4, 10.0f);
    out.duty_cycle = wcvesc_pop_f16(wccan_frame_get_data(frame)+6, 1000.0f);
    return out;
}
wcvesc_status2_t wcvesc_decode_status2(const wccan_frame_t* frame){
    wcvesc_status2_t out;
    out.amp_hours = wcvesc_pop_f32(wccan_frame_get_data(frame), 10000.0f);
    out.amp_hours_charged = wcvesc_pop_f32(wccan_frame_get_data(frame)+4, 10000.0f);
    return out;
}
wcvesc_status3_t wcvesc_decode_status3(const wccan_frame_t* frame){
    wcvesc_status3_t out;
    out.watt_hours = wcvesc_pop_f32(wccan_frame_get_data(frame), 10000.0f);
    out.watt_hours_charged = wcvesc_pop_f32(wccan_frame_get_data(frame)+4, 10000.0f);
    return out;
}
wcvesc_status4_t wcvesc_decode_status4(const wccan_frame_t* frame){
    wcvesc_status4_t out;
    out.temp_fet = wcvesc_pop_f16(wccan_frame_get_data(frame), 10.0f);
    out.temp_motor = wcvesc_pop_f16(wccan_frame_get_data(frame)+2, 10.0f);
    out.current_in = wcvesc_pop_f16(wccan_frame_get_data(frame)+4, 10.f);
    out.pid_pos = wcvesc_pop_f16(wccan_frame_get_data(frame)+6, 50.0f);
    return out;
}
wcvesc_status5_t wcvesc_decode_status5(const wccan_frame_t* frame){
    wcvesc_status5_t out;
    out.tachometer = wcvesc_pop_f32(wccan_frame_get_data(frame), 6.0f);
    out.volts_in = wcvesc_pop_f16(wccan_frame_get_data(frame), 10.0f);
    return out;
}
wcvesc_status6_t wcvesc_decode_status6(const wccan_frame_t* frame){
    wcvesc_status6_t out;
    out.adc1 = wcvesc_pop_f16(wccan_frame_get_data(frame), 1000.0f);
    out.adc2 = wcvesc_pop_f16(wccan_frame_get_data(frame), 1000.0f);
    out.adc3 = wcvesc_pop_f16(wccan_frame_get_data(frame), 1000.0f);
    out.ppm = wcvesc_pop_f16(wccan_frame_get_data(frame), 1000.0f);
    return out;
}
